...
<div class="row">
	<form class="form-horizontal" action="update.html?id=${form.id}" method="post">
		...
		<div class="form-group">
			...
			<div class="col-sm-10">
				<textarea class="form-control" id="detail" name="detail" placeholder="詳細" rows="3">${form.detail}</textarea>
			</div>
		</div>
		<div class="form-group">
		...
		<div class="form-group">
			...
			<div class="col-sm-10">
				<input type="text" class="form-control" id="limit" name="limit_date" placeholder="期限" value="${form.limitDate}">
			</div>
		</div>
		<div class="form-group">
			...
			<div class="col-sm-2 text-right">
				<a href="delete.html?id=${form.id}" class="btn btn-danger">削 除</a>
			</div>
		</div>
	</form>
</div>
